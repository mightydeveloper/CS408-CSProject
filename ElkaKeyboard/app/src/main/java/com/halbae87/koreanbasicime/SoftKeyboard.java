...
public class SoftKeyboard extends InputMethodService 
    ...
    static final float SOBER_THRESHOLD = 0.75f;
    ...
    @Override public void onCreate() {
        ...
        CharSequence normalized = TwitterKoreanProcessorJava.normalize("최상의컨디ㅣ샨으러 깨어ㄴ있을수있으면좋게ㅛㅆ다");
    ...
    */
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        if(mInputView.isBlocked) {
            Log.v(TAG, "onKey - blocked");
            startActivity(new Intent(this, Sentence.class));
            unblockKeyboard();
            return;
        }
